...
class XmpAreaStruct:
    ...
    def __eq__(self, arg: XmpAreaStruct, /) -> bool: ...
    @property
    def H(self) -> float: ...
    @H.setter
...
class DimensionsStruct:
    ...
    def __eq__(self, arg: DimensionsStruct, /) -> bool: ...
    @property
    def H(self) -> float: ...
    @H.setter
    def H(self, arg: float, /) -> None: ...
...
class RegionStruct:
    ...
    def __eq__(self, arg: RegionStruct, /) -> bool: ...
    @property
...
class RegionInfoStruct:
    ...
    def __eq__(self, arg: RegionInfoStruct, /) -> bool: ...
    @property
...
class KeywordStruct:
    ...
    def __eq__(self, arg: KeywordStruct, /) -> bool: ...
    @property
...
class KeywordInfoModel:
    ...
    def __eq__(self, arg: KeywordInfoModel, /) -> bool: ...
    @property
